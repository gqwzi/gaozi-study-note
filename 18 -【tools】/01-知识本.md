...
【mysql赋权限】GRANT ALL PRIVILEGES ON *.* TO 'root'@'192.168.5.31'identified by 'vipkid';
...
【手动添加jar】mvn install:install-file  -Dfile=C:\Users\gaoqiangwei\Desktop\web-utils-1.1.jar  -DgroupId=com.vipkid.utils  -DartifactId=web-utils -Dversion=1.1 -Dpackaging=jar
...
【linux awk切割】
cat /opt/vipkid/teacher-pr/logs/partner-referral.log | grep "send referral message to payroll msg" | awk -F body={ '{ print $2}' | awk -F "refereeId" '{ print $1}' > /home/gaoqiangwei/test.txt
